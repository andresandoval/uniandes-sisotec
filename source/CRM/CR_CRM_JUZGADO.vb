...
Public Class CR_CRM_JUZGADO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISOTEC.CR_CRM_JUZGADO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_CRM_JUZGADO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_CRM_JUZGADO = New CR_CRM_JUZGADO
        rpt.Site = Me.Site
        Return rpt
    End Function
