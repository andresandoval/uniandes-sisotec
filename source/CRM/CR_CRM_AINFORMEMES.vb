...
Public Class CR_CRM_AINFORMEMES
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISOTEC.CR_CRM_AINFORMEMES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_CRM_AINFORMEMES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_CRM_AINFORMEMES = New CR_CRM_AINFORMEMES
        rpt.Site = Me.Site
        Return rpt
    End Function
