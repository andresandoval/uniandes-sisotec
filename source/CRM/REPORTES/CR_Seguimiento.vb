...
Public Class CR_Seguimiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISOTEC.CR_Seguimiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Seguimiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Seguimiento = New CR_Seguimiento
        rpt.Site = Me.Site
        Return rpt
    End Function
