...
Public Class CRE_Seguimiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISOTEC.CRE_Seguimiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRE_Seguimiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRE_Seguimiento = New CRE_Seguimiento
        rpt.Site = Me.Site
        Return rpt
    End Function
