...
Public Class rptInformeUnico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISOTEC.rptInformeUnico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInformeUnico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInformeUnico = New rptInformeUnico
        rpt.Site = Me.Site
        Return rpt
    End Function
