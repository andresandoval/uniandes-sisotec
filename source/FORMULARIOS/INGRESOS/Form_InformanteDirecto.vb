Public Class Form_InformanteDirecto
    ...
    End Sub
    Sub Consulta_SGBD()
        Me.DGV_PERSONA.DataSource = consulta_Sql.Consulta_General("Vista_InformanteDirecto")
    End Sub
    Sub EtiquetasDGV()
    ...
    Private Sub Form_InformanteDirecto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.EstiloDataGrid()
    ...
    Private Sub DGV_PERSONA_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGV_PERSONA.CellClick
        ...
        dt_apod = consulta_Sql.Consulta_Individual("Vista_InformanteDirecto", "CEPERS_CODIGO", codigodvg)
        Me.mostrar_dgv()
    End Sub
        ...
        Try
            ...
            Else
                If GuardarEditar <> 1 Then
                    ...
                    valoresc = " '" & Me.txt_cedu.Text & "','" & Me.txt_nomb.Text & "','" & Me.txt_apel.Text & "','" & FormatDateTime(Me.dtm_fena.Text) & "','" & txt_edad.Text & "','" & txt_ocup.Text & "','" & cbb_gene.Text & "','" & cbb_esci.Text & "','" & txt_domi.Text & "','" & txt_pare.Text & "','" & txt_tele.Text & "','" & txt_niin.Text & "','" & txt_ning.Text & "','" & txt_meap.Text & "','" & txt_inac.Text & "','" & "INFORMANTE DIRECTO" & "' "
            ...
            End If
        Catch ex As Exception
            MsgBox("El registro ya existe" & vbCrLf & ex.Message)
            Me.txt_cedu.Focus()
        End Try
    End Sub
    ...
    Private Sub BN_EDITAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BN_EDITAR.Click
        ...
        Else
            ActivarCajaTexto()
            Me.ActivarBotones()
            Me.cbb_tipo.Text = "INFORMANTE DIRECTO"
            'Me.llenar_tipo()
            Me.txt_nomb.Focus()
            GuardarEditar = 1
        End If
