Public Class Form_InformantesColaterales
    ...
    Sub mostrar_dgv()
        ...
        Me.txt_pare.Text = dt_apod.Rows(0).Item(4).ToString
        ...
        Me.txt_tele.Text = dt_apod.Rows(0).Item(9).ToString
    End Sub
    Sub Consulta_SGBD()
        Me.DGV_PERSONA.DataSource = consulta_Sql.Consulta_General("Vista_InformanteColateral")
    End Sub
    Sub EtiquetasDGV()
        ...
        Me.DGV_PERSONA.Columns(4).HeaderText = "PARENTESCO"
        ...
        Me.DGV_PERSONA.Columns(9).HeaderText = "TELEFONO"
    End Sub
    ...
    Sub EstiloDataGrid()
        ...
        Me.DGV_PERSONA.DefaultCellStyle.ForeColor = Color.Black
        Me.DGV_PERSONA.DefaultCellStyle.BackColor = Color.Transparent
        Me.DGV_PERSONA.DefaultCellStyle.SelectionForeColor = Color.Black
    ...
    Private Sub Form_InformantesColaterales_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.EstiloDataGrid()
        Me.CambiarColorFila(DGV_PERSONA)
        Me.Consulta_SGBD()
        Me.EtiquetasDGV()
        'Me.llenar_tipo()
        Me.MAYUSCULAS()
    ...
    Private Sub BN_GUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BN_GUARDAR.Click
        ...
        Else
            If GuardarEditar <> 1 Then
                ...
                valoresc = " '" & Me.txt_cedu.Text & "','" & Me.txt_nomb.Text & "','" & Me.txt_apel.Text & "','" & FormatDateTime(Me.dtm_fena.Text) & "','" & txt_edad.Text & "','" & txt_ocup.Text & "','" & cbb_gene.Text & "','" & cbb_esci.Text & "','" & txt_domi.Text & "','" & txt_pare.Text & "','" & txt_tele.Text & "','" & txt_niin.Text & "','" & txt_ning.Text & "','" & txt_meap.Text & "','" & txt_inac.Text & "','" & "INFORMANTE COLATERAL" & "' "
    ...
    Private Sub BN_EDITAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BN_EDITAR.Click
        ...
        Else
            ActivarCajaTexto()
            Me.ActivarBotones()
            Me.cbb_tipo.Text = "INFORMANTE COLATERAL"
            'Me.llenar_tipo()
            Me.txt_nomb.Focus()
            GuardarEditar = 1
        End If
    ...
    Private Sub DGV_PERSONA_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGV_PERSONA.CellClick
        ...
        dt_apod = consulta_Sql.Consulta_Individual("Vista_InformanteColateral", "CEPERS_CODIGO", codigodvg)
        Me.mostrar_dgv()
    End Sub
    ...
    Private Sub txt_apel_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_apel.KeyPress
        ...
        Me.txt_nomb.MaxLength = 60
        validacion.salto(txt_apel, txt_pare, e)
    End Sub
    ...
    Private Sub txt_pare_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_pare.KeyPress
        ...
        Me.txt_pare.MaxLength = 80
        validacion.salto(txt_pare, txt_edad, e)
    End Sub
    ...
    Private Sub cbb_esci_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbb_esci.KeyPress
        validacion.salto(cbb_esci, txt_tele, e)
    End Sub
    ...
    Private Sub txt_tele_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_tele.KeyPress
        validacion.solo_numeros(txt_tele, e)
        txt_tele.MaxLength = 14
        validacion.salto2(txt_tele, cbb_tipo, e)
    End Sub
End Class