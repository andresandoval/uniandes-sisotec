Public Class Form_SujetoDerechos
    ...
    End Sub
    Sub Consulta_SGBD()
        Me.DGV_PERSONA.DataSource = consulta_Sql.Consulta_General("Vista_SujetoDerecho_Tipo")
    End Sub
    ...
    Private Sub DGV_PERSONA_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGV_PERSONA.CellClick
        ...
        dt_apod = consulta_Sql.Consulta_Individual("Vista_SujetoDerecho_Tipo", "CEPERS_CODIGO", codigodvg)
        Me.mostrar_dgv()
    End Sub
    ...
    Private Sub BN_GUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BN_GUARDAR.Click
        ...
        Else
            If GuardarEditar <> 1 Then
                ...
                valoresc = " '" & Me.txt_cedu.Text & "','" & Me.txt_nomb.Text & "','" & Me.txt_apel.Text & "','" & FormatDateTime(Me.dtm_fena.Text) & "','" & txt_edad.Text & "','" & txt_ocup.Text & "','" & cbb_gene.Text & "','" & cbb_esci.Text & "','" & txt_domi.Text & "','" & txt_pare.Text & "','" & txt_tele.Text & "','" & txt_niin.Text & "','" & txt_ning.Text & "','" & txt_meap.Text & "','" & txt_inac.Text & "','" & "SUJETO DE DERECHO" & "' "
    ...
    Private Sub BN_EDITAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BN_EDITAR.Click
        ...
        Else
            ActivarCajaTexto()
            Me.ActivarBotones()
            Me.cbb_tipo.Text = "SUJETO DE DERECHO"
            Me.txt_nomb.Focus()
            GuardarEditar = 1
        End If
        Consulta_SGBD()
