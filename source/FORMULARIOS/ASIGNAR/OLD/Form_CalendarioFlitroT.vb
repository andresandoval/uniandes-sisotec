...
Public Class Form_CalendarioFlitroT
    ...
    Private Sub Form_CalendarioFlitro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End Try
        dt_apod = consulta_Sql.Consulta_Individual("Vista_nombreTecnico", "CEPERS_CODIGO", codigopersona)

        ta_vp = tab("Vista_nombreTecnico")
        ta_vp.Fill(ds, "Vista_nombreTecnico")
        bs_vp.DataSource = ds.Tables("Vista_nombreTecnico")
        ComboBox1.DataSource = consulta_Sql.Consulta_Individual("Vista_nombreTecnico", "CEPERS_CODIGO", codigopersona)
        Me.ComboBox1.ValueMember = "CEPERS_CODIGO"
        Me.ComboBox1.DisplayMember = "NOMBRE"
        REM    Me.TextBox1.DataBindings.Add(New System.Windows.Forms.Binding("Text", bs_vp, "CARGO", True))
        ...
        If (e.ColumnIndex = 5 Or e.ColumnIndex = 7 Or e.ColumnIndex = 9 Or e.ColumnIndex = 11 Or e.ColumnIndex = 13 Or e.ColumnIndex = 15 Or e.ColumnIndex = 17) Then
            If DataGridView1(e.ColumnIndex, e.RowIndex).Value Is DBNull.Value Then
                ...
                Else
                    ...
                    Dim re As Date
                    re = DataGridView1(e.ColumnIndex + 1, e.RowIndex).Value

                    If re.Month >= Now.Month Then
                        ...
                        Hide()
                    Else
                        MessageBox.Show("El mes selecciona es inferior al mes actual")
                    End If
