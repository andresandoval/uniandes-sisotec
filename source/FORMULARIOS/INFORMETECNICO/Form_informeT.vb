Public Class Form_informeT
    ...
    Private Sub Form_informe_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        bs.Filter = "CEINFO_ESTADO='PENDIENTE' and CEPERS_CODIGO=" & codigopersona.ToString
        ...
        bs_v.Filter = "ESTADO='PENDIENTE' and CEPERS_CODIGO=" + codigopersona.ToString
        Me.updateChangeRow()
    End Sub
