Public Class Form_informe
    ...
    Private Sub Form_informe_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        REM Me.DGV_SujetoDerecho.DataSource = consulta_Sql.Consulta_Individual("Vista_detalleInformes", "CFDEIN_ROLXXX ='SUJETO DE DERECHO' and CEINFO_CODIGO", Val(CEINFO_CODIGOTextBox.Text))
        ...
        Me.DGV_demandante.Columns(2).Width = 600
        ...
        REM Le quite para que me salgan los informes totales
        ...
        Me.DGV_InformanteDirecto.Columns(0).Width = 600
        ...
        Me.DGV_InformanteColateral.Columns(0).Width = 600
    ...
    Private Sub BN_IMPRIMIR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BN_IMPRIMIR.Click
        Dim Reportecategoria As New CrystalReport_informe
        Dim ver As New Form_verReportes
        Reportecategoria.SetDataSource(Me.consulta_Sql.Consulta_Filtro2("Vista_informe", "CEINFO_CODIGO", Val(CEINFO_CODIGOTextBox.Text)))
